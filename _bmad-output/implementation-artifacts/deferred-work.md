...
**D-7.2-A — Balance constants are hand-transcribed into the host with no drift detection** [`apps/host-client/src/vfx/ability-vfx.ts:95-144`, `apps/host-client/src/vfx/ability-vfx.test.ts:13-15`]
