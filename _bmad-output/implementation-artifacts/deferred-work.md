...
**D-3.20-A — AC4's "steady-tick damage" isn't integration-tested at the GameRoom level** [`apps/simulation-server/src/rooms/GameRoom.ts`, zone-tick loop `'damage'` effectType case]
